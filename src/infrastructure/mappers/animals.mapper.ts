...
import { animAPIanimals } from "../interfaces/animalsApi.interfaces";

export class AnimalsMapper {
    static async animaApiAnimalsToEntity(data:animAPIanimals):Promise<Animals>{
    const sprites = AnimalsMapper.getSprites(data);
  ...
  static getSprites(data: animAPIanimals): string[] {
